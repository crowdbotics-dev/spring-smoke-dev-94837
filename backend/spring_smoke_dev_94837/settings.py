"""
Django settings for spring_smoke_dev_94837 project.
...
ROOT_URLCONF = 'spring_smoke_dev_94837.urls'
...
WSGI_APPLICATION = 'spring_smoke_dev_94837.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_smoke_dev_94837 API",
    "DESCRIPTION": "API documentation for spring_smoke_dev_94837 App",
    "VERSION": "v1",
}
